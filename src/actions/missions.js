...
import { ADD_MISSION, SET_MISSIONS, REMOVE_MISSION, EDIT_MISSION, MISSIONS_LOADING } from './actionvariables';
...
export const startAddMission = (missionData = {}) => {
  return (dispatch, getState) => {
    ...
    const mission = {name, dm, characters, playedOn, episode, levelMin, levelMax};
