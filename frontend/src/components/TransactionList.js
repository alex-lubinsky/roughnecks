  ...
  render() {
    return (
      <div>
        ...
        {this.props.transactionsIsLoading || this.props.charactersIsLoading ? null : 
          <TransactionsTable transactions={this.props.transactions} characters={this.props.characters}/>
        }
      </div>
    )
  }
